...
class MindExPage2 extends StatefulWidget {
  const MindExPage2({Key? key}) : super(key: key);

  @override
  State<MindExPage2> createState() => _MindExPage2();
}

class _MindExPage2 extends State<MindExPage2> {
